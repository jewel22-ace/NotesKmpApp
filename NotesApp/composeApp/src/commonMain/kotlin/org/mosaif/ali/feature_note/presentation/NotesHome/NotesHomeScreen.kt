...
import org.mosaif.ali.feature_note.presentation.NotesHome.components.NoteItem
...
fun NotesHomeScreen(
    ...
    Scaffold(
        floatingActionButton = {
            FloatingActionButton(
                onClick = {
                    navController.navigate(Screens.AddEditNoteScreen.name)
                },
                        ...
                        modifier = Modifier
                            ...
                            .clickable {
                                navController.navigate(
                                    Screens.AddEditNoteScreen.name +
